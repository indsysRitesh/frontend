...
function LoginPage() {
    ...
    const onSubmit = async (e) => {
        ...
        if (Object.keys(errors).length > 0) {
            ...
            const apiUrl = 'http://localhost:9898/user/login';
                            ...
                            <div className="col-xl-5 col-md-6">
                                <div className="login-area">
                                    ...
                                    <form className="login-form" id="login-form" onSubmit={onSubmit}>
                                        ...
                                        />
                                        {validationErrors.userName && <p className="error-message text-danger">{validationErrors.userName}</p>}
                                        ...
                                        <div className="row login-form">
                                            ...
                                            <div className="col-xl-6 col-md-6 col-sm-12">
                                                <NavLink className="w-100" to="/registrationpage">
