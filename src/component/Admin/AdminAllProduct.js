...
const AdminAllProduct = () => {
    ...
    const handleUpdateProduct = (product) => {
        ...
        navigate('/adminaddproduct', { state: { productToUpdate: product } });
      };
                                    ...
                                    <div className="panel-header">
                                        ...
                                        <div className="btn-box d-flex flex-wrap gap-2">
                                            ...
                                            <div className="btn-box">
                                                <a href="/adminaddproduct" className="btn btn-sm btn-primary"><i className="fa-light fa-plus"></i> Add New</a>
                                            </div>
                                        </div>
                                    </div>
