...
function AdminRegistration() {
    ...
    const onSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
          ...
          axios.post('http://localhost:9898/admin/add', Registration)
                    ...
                    <div className="container">
                        <div className="row justify-content-around">
                            <div className="col-xl-5 col-md-6">
                                <div className="login-area author-area">
                                    ...
                                    <form className="login-form" id='regi-form' onSubmit={onSubmit}>
                                        <input
                                            type="text"
                                            placeholder="Name"
                                            name="adminName"
                                        ...
                                        />
                                           {validationErrors.adminName && (
                                            <p className=' text-danger error-message'>{validationErrors.adminName}</p>
                                        )}
                                        <input
                                            type="email"
                                            placeholder="Email"
                                        ...
                                        />
                                           {validationErrors.adminEmail && (
                                            <p className=' text-danger error-message'>{validationErrors.adminEmail}</p>
                                        )}
                                        <input
                                            type="password"
                                        ...
                                        <textarea
                                            ...
                                            value={adminAddress}
                                        ></textarea>
                                           {validationErrors.adminAddress && (
                                            <p className=' text-danger error-message'>{validationErrors.adminAddress}</p>
                                        )}
                                        <input
                                            type="file"
                                            placeholder="photo"
                                        ...
                                        <div className="form-check">
                                            ...
                                            <span className="sub-input"><i className="fa-regular fa-check"></i></span>
                                            <label className="form-check-label" for="agreeToTerm">
                                                Agree to the <a href="/#">Terms and Conditions</a>
                                            </label>
                                            </div>
                                        {/* <NavLink to="/shopdetails">  */}
                                        <button className="def-btn btn-border" type ='submit' >Submit</button>
                                        {/* </NavLink>  */}
                                    </form>
