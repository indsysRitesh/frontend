...
const AdminAllCustomer = () => {
    ...
    const [AllCustomer, SetTableAllCustomer] = useState([]);

    useEffect(() => {
        axios.get("http://localhost:9898/user/getall")
            .then(response => response.data)
            .then(res => {
                console.log(res)
                SetTableAllCustomer(res)
            })
    }, [])
    ...
    const totalPages = Math.ceil(AllCustomer.length / rowsToShow);
    ...
    const slicedAllCustomer = AllCustomer.slice(startIndex, endIndex);
                                ...
                                <div className="panel">
                                    ...
                                    <div className="panel-body">
                                        ...
                                        <table className="table table-dashed table-hover digi-dataTable all-product-table table-striped" id="allProductTable">
                                            ...
                                            {slicedAllCustomer.map((display, ind) => (
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div className="form-check">
